...
sudo pacman -S --noconfirm tmux chromium compton htop rofi zip

# Fonts
sudo pacman -S --noconfirm adobe-source-code-pro-fonts adobe-source-han-sans-cn-fonts adobe-source-han-sans-tw-fonts adobe-source-han-serif-cn-fonts adobe-source-han-serif-tw-fonts ttf-dejavu ttf-freefont ttf-ubuntu-font-family ttf-liberation ttf-font-awesome
